...
const WHATSAPP_NUMBER = "8801736066568";
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="whatsapp-pulse-delay absolute inset-0 rounded-full bg-[#25D366]" />
      ...
      {/* Popup tooltip */}
      {showTooltip && (
        <span className="whatsapp-tooltip absolute bottom-full right-0 mb-2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white shadow-lg">
