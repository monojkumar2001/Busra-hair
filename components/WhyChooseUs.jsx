  ...
  <section id="benefits" className="py-20 bg-green-900 text-white overflow-hidden relative">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-5xl font-black mb-6">কেন আমাদের অয়েলটি সেরা?</h2>
        <p className="text-green-200 text-lg">প্রকৃতির সেরা উপাদানের সঠিক সমন্বয়</p>
      </div>
          ...
          {[
            ...
            return (
              <div key={idx} className="flex gap-6 items-start group">
                <div className="bg-green-800 p-4 rounded-2xl text-green-400 group-hover:bg-green-400 group-hover:text-green-900 transition-all flex-shrink-0">
                  <Icon size={32} />
                </div>
                <div>
                  <h4 className="text-2xl font-bold mb-2 text-green-100">{benefit.title}</h4>
                  <p className="text-green-200/80 leading-relaxed text-lg">{benefit.desc}</p>
                </div>
              </div>
            );
          })}
